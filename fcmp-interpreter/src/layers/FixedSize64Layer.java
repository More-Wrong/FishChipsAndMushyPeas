...
public class FixedSize64Layer implements Layer {
	...
	public FixedSize64Layer(int layerNumber, Set<DataType> allowedTypes, int xSize, int ySize,
			TriggerCallback triggerCall) {
		this.layerNumber = layerNumber;
		this.allowedTypes = allowedTypes;
		this.xSize = xSize;
		this.ySize = ySize;
		this.data = new long[ySize * xSize];
		...
		case SINGLEFLOAT:
			...
			break;
		case DOUBLEFLOAT:
			defaultData = Double.doubleToRawLongBits(0.0);
			break;
		default:
			defaultData = 0;
			break;
